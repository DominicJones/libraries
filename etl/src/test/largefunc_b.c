/*        Generated by TAPENADE     (INRIA, Ecuador team)
  ...
  Differentiation of largefunc in reverse (adjoint) mode:
...
*/
void largefunc_b(const double arg0, double *arg0b, const double arg1, double *
        arg1b, const double arg2, const double arg3, const double arg4, double
        *result, double *resultb) {
    double c1 = 1;
    double c2 = 2;
    double c3 = 3;
    double c4 = 4;
